...
def tune_test(lmdb_path, name, model_path):
    ...
    blender.module.load_state_dict(torch.load("/home/wuhz/mnt/avatar/style_avatar/render/model/render_lrw_lr_2e-4_blend_4/generator.pkl"))
    ...
    for i in tqdm(range(1)):
        ...
        with torch.no_grad():
            ...
            os.system("ffmpeg -y -loglevel warning -framerate 25 -start_number 0 -i ../data/tmp/test/%d.png -c:v libx264 -pix_fmt yuv420p -b:v 2000k ../data/demo_notune/{}_{}.mp4".format(name, i))
            os.system("ffmpeg -y -loglevel warning -i ../data/demo_notune/{}_{}.mp4 -i {} -map 0:v -map 1:a -c:v copy -shortest ../data/demo_notune/{}_{}_a.mp4".format(name, i, test_audio_path, name, i))
