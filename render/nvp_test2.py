...
def tune_test(lmdb_path, name, model_path):
    ...
    for i in tqdm(range(1)):
        ...
        with torch.no_grad():
            ...
            os.system("ffmpeg -y -loglevel warning -framerate 25 -start_number 0 -i ../data/tmp/test/%d.png -c:v libx264 -pix_fmt yuv420p -b:v 2000k ../data/demo_nvp/{}_{}.mp4".format(name, i))
            os.system("ffmpeg -y -loglevel warning -i ../data/demo_nvp/{}_{}.mp4 -i {} -map 0:v -map 1:a -c:v copy -shortest ../data/demo_nvp/{}_{}_a.mp4".format(name, i, test_audio_path, name, i))
...
if __name__ == "__main__":
    ...
    model_path = "./ted_model/demo_nvp_0"
    name = "demo_nvp_0"

    tune_test(lmdb_path, name, model_path)

    lmdb_path = "../data/demo_1"
    model_path = "./ted_model/demo_nvp_1"
    name = "demo_nvp_1"

    tune_test(lmdb_path, name, model_path)

    lmdb_path = "../data/demo_2"
    model_path = "./ted_model/demo_nvp_2"
    name = "demo_nvp_2"
